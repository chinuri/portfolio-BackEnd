...
import com.miportfolio.cgc.Dto.dtoEducacion;
import com.miportfolio.cgc.Entity.Educacion;
import com.miportfolio.cgc.Security.Controller.Mensaje;
import com.miportfolio.cgc.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion) {
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreE(), dtoeducacion.getDescripcionE(), dtoeducacion.getUrlE()
        );
